...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-manifoldjs/node_modules/manifoldjs-lib/lib/utils.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-manifoldjs/node_modules/manifoldjs-lib/lib/utils.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">26.42% <small>(14 / 53)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-manifoldjs/node_modules/manifoldjs-lib/lib/</a> &#187; utils.js</div>
</div>
<div class="body">
...
var os = require('os'),
  ...
  path = require('path');
&nbsp;
<span class="fstat-no" title="function not covered" >function parseJSON (data) {</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    var jsonString = data.toString().replace(/^\uFEFF/, '');</span>
...
<span class="fstat-no" title="function not covered" >function isFunction (data) {</span>
<span class="cstat-no" title="statement not covered" >  var getType = {};</span>
<span class="cstat-no" title="statement not covered" >  return data &amp;&amp; getType.toString.call(data) === '[object Function]';</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isString (data) {</span>
<span class="cstat-no" title="statement not covered" >  return typeof data === 'string';</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function capitalize (string) {</span>
<span class="cstat-no" title="statement not covered" >  return (isString(string) &amp;&amp; string.length &gt; 0 ? string.charAt(0).toUpperCase() + string.slice(1) : '');</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function newGuid () {</span>
...
<span class="fstat-no" title="function not covered" >function sanitizeName (name) {</span>
<span class="cstat-no" title="statement not covered" >  var sanitizedName = name;</span>
  
  // Remove all invalid characters
<span class="cstat-no" title="statement not covered" >  sanitizedName = sanitizedName.replace(/[^A-Za-z0-9\.]/g, '');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var currentLength;</span>
<span class="cstat-no" title="statement not covered" >  do {</span>
<span class="cstat-no" title="statement not covered" >    currentLength = sanitizedName.length;</span>
    
    // If the name starts with a number, remove the number 
<span class="cstat-no" title="statement not covered" >    sanitizedName = sanitizedName.replace(/^[0-9]/, '');</span>
    
    // If the name starts with a dot, remove the dot
<span class="cstat-no" title="statement not covered" >    sanitizedName = sanitizedName.replace(/^\./, '');</span>
    
    // If there is a number right after a dot, remove the number
<span class="cstat-no" title="statement not covered" >    sanitizedName = sanitizedName.replace(/\.[0-9]/g, '.');</span>
    
    // If there are two consecutive dots, remove one dot
<span class="cstat-no" title="statement not covered" >    sanitizedName = sanitizedName.replace(/\.\./g, '.');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (sanitizedName.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >    sanitizedName = 'myManifoldJSApp';</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return sanitizedName;</span>
}
&nbsp;
// Function to remove duplicates from any array
<span class="fstat-no" title="function not covered" >function removeDupesInPlace (arr, comparator) {</span>
<span class="cstat-no" title="statement not covered" >  for (var i = 0; i &lt; arr.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    for (var j = arr.length - 1; j &gt; i; j--) {</span>
<span class="cstat-no" title="statement not covered" >      if (comparator(arr[j], arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >        arr.splice(j, 1);</span>
      }
    }
  }
...
<span class="fstat-no" title="function not covered" >function isURL (data) {</span>
<span class="cstat-no" title="statement not covered" >  return (typeof data === 'string' &amp;&amp; urlRegex.test(data));</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getDefaultShortName (siteUrl) {</span>
<span class="cstat-no" title="statement not covered" >  var shortName = '';</span>
<span class="cstat-no" title="statement not covered" >  url.parse(siteUrl)</span>
    .hostname
    .split('.')
    .map(<span class="fstat-no" title="function not covered" >function (segment) {</span>
<span class="cstat-no" title="statement not covered" >      segment.split('-').map(<span class="fstat-no" title="function not covered" >function (fraction) {</span></span>
<span class="cstat-no" title="statement not covered" >        shortName = shortName + capitalize(fraction);</span>
      });
    });
&nbsp;
...
<span class="fstat-no" title="function not covered" >function getRootPackagePath() {</span>
<span class="cstat-no" title="statement not covered" >  var fileName = path.basename(require.main.filename);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (fileName === 'interceptor.js') {</span>
<span class="cstat-no" title="statement not covered" >    if (require.main.children.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >      return require.main.children[0].filename;</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return require.main.filename;</span>
}
&nbsp;
module.exports = {
  parseJSON: parseJSON,
